...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center contenido">
            <div class="card  p-3">
                <form class="" action="" method="POST" id="frmUsuarios" onsubmit="registrarUsuario(); return false; >
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="passwordInput" name="password_usuario">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <div>
                        ...
                        <select id="privilegio" class="form-select" id="privilegio_usuario" name="privilegio_usuario"
                            required>
                            <option value="" selected>Seleccione...</option>
                            <?php
                            foreach ($datos['privilegio'] as $row) { ?>
            ...
            <div class="row mb-3">
                <div class="col">
                    <div>
                        ...
                        <select id="laboratorio" class="form-select" id="laboratorio_usuario" name="laboratorio_usuario"
                            required>
                            <option value="" selected>Seleccione...</option>
                            <?php
                ...
                <div class="col mb-3">
                    ...
                    <div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="estado_usuario" name="estado_usuario"
                                checked>
