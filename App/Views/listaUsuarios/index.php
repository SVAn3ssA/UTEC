        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="frmprueba">
                    ...
                    <p>
                        Si desea actualizar la contraseña de este usuario por favor llene los 2 campos. Si NO
                        desea actualizar la contraseña deje los campos vacíos.
                    </p>
                    <div class="row mb-3">
                        <div class="col">
                            <label class="form-label">Nueva Contraseña:</label>
                            <input class="form-control" type="password" name="usuario_clave_1">
                        </div>
                        <div class="col">
                            <label class="form-label">Repetir nueva Contraseña:</label>
                            <input class="form-control" type="password" name="usuario_clave_2">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
